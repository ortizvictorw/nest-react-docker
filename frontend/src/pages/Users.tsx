...
import { Loader, Plus, RefreshCw, X, Zap } from 'react-feather';
...
import { generateUserName } from '../services/aIService';
...
export default function Users() {
  ...
  const generateUsername = async () => {
    try {
      ...
      const { firstName, lastName, preference } = getValues();
      ...
      console.error(err);
      setError('Failed to generate username. Try again.');
    } finally {
